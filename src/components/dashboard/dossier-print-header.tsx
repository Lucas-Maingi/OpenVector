  ...
  return (
    <div className="hidden print:block w-full border-b-2 border-slate-900 pb-6 mb-8 mt-4">
      ...
      <div className="grid grid-cols-2 gap-8 pt-4">
        <div>
          <div className="text-[10px] text-slate-500 font-bold uppercase mb-1">Subject Description</div>
          <div className="text-sm font-bold text-slate-900 uppercase">{title}</div>
        </div>
        <div className="text-right">
          <div className="text-[10px] text-slate-500 font-bold uppercase mb-1">Investigation Vector</div>
      ...
      <div className="mt-4 flex items-center justify-between">
        <div className="flex items-center gap-6">
          <div>
            <span className="text-[9px] text-slate-400 font-bold uppercase mr-2">Sensitivity:</span>
            <span className="text-[9px] font-bold text-slate-900 border border-slate-900 px-1.5 py-0.5 rounded">CONFIDENTIAL</span>
          </div>
          <div>
            <span className="text-[9px] text-slate-400 font-bold uppercase mr-2">Retention:</span>
